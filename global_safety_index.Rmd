...
<h4><div class="newspaper1">
<p style="text-align: justify;">
Well, let's put this in a different context. There are many ways in which nations can compare their performance one to another. For instance, looking at performance measures, "among the 35 members of the Organization for Economic Cooperation and Development ... the U.S. ranked [30th in math and 19th in science](http://www.pewresearch.org/fact-tank/2017/02/15/u-s-students-internationally-math-science/)"; by spending, we rank first in the [military](http://www.pgpf.org/chart-archive/0053_defense-comparison); In terms of prison population, we also [top the chart](http://www.prisonstudies.org/world-prison-brief-data). The point is that creating a benchmark provides a point of reference for policymakers and the general public. As such, creating a unified safety index at the global scale can provide a guide point in improving public safety.</p></div>
