...
<p style="text-align: justify;">
**Introduction**
  <br><br>When you hear me say, “higher number of first responders did not lower injury rate in non-medical responses,” a question may come to mind — why would you predict the probability of injury by looking at the number of first responders? This is a fair question to have. After all, injuries occur before ambulances arrive. I began examining the effect of first responders on injury rate because nearly 99% of non-medical ambulance deployments in the City of San Francisco do not result in fatality or injury. That said, I think it is fair to ask whether increasing the number of first responders can reduce the injury rate. If not, can the city spend those millions of dollars more efficiently?   <br><br>    Now that you understand why I am examining the effect of first responders on injury rate, let's briefly talk about what happens in emergencies. We know that most injuries occur before first responders respond to 9-1-1 calls. If there is one patient, then any number of first responders should not make a difference because there is going to be one patient, no matter how many people respond to the emergency call. Take the following hypothetical scenarios for example:</p></div><br><br>
...
```
<br>
<center>Above map shows every ambulance response made to non-medical emergencies (2003-2015).</center>
